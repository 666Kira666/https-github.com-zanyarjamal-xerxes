...
<html lang="en">
    <head>
        ...
        <script src="<?=assets('klinger/js/main.js')?>" ></script>
            ...
            <div class="container">
                ...
                ?>
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?=route('usrlog')?>">Usuários</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?=route('usrcoment')?>">Comentários</a></li>
