...
<div class="animationload"><div class="loader">Loading...</div></div> <!-- End Preloader -->
            ...
            <div class="tp-banner">
                <ul>
       			  <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <!-- MAIN IMAGE -->
                        <img src="http://www.takeatakefilms.com/site2023/wp-content/uploads/2015/04/consciencia_thumb.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                     ...
                     <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <!-- MAIN IMAGE -->
                        <img src="https://jurinews.com.br/wp-content/uploads/2022/05/WhatsApp-Image-2022-05-05-at-23.46.40.jpeg"  alt="slidebg2"  data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
        				<div class="tp-dottedoverlay twoxtwo"></div>
					...
					<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <!-- MAIN IMAGE -->
                        <img src="https://cdn.diocesevaladares.com.br/wp-content/uploads/2020/07/Respeito.jpg"  alt="slidebg3"  data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
        				<div class="tp-dottedoverlay twoxtwo"></div>
	...
	<section id="features" class="feature-wrapper">
		...
		<div data-scroll-reveal="enter from the bottom after 0.3s" class="title text-center" data-scroll-reveal-id="2" data-scroll-reveal-initialized="true" data-scroll-reveal-complete="true">
                        ...
                        <h5 style='text-align:left'> Segundo o site do senado Brasileiro, intolerância religiosa é um conjunto de ideologias e atitudes ofensivas a crenças e práticas religiosas ou mesmo a quem não segue uma religião. É um crime de ódio que fere a liberdade e a dignidade humana. </h5>


                        <hr>
                    </div>
		  <div data-scroll-reveal="enter from the bottom after 0.4s" class="feature-img">
                <img class="img-responsive" src="https://jurinews.com.br/wp-content/uploads/2022/05/WhatsApp-Image-2022-05-05-at-23.46.40.jpeg" alt=""> 
            </div>

                        <p> A liberdade de crença é uma das garantias do Estatuto da Igualdade Racial, Lei 12.288/2010. A lei protege as religiões de matriz africana e os locais de culto. Apesar do respaldo legal, organizações dizem que há cada vez mais casos de violação desse direito. Segundo um arquivo retirado da Agência do Brasil de 2011 a 2014, do total das 504 denúncias, 213 informaram a religião atacada. Em 35% desses casos, trata-se de religiões de matriz africana. </p>

        	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
            	<div class="widget">
                	<h3> Mas o que são as religiões de matriz africana? </h3>
                    <h5> No Brasil, Religiões de matriz africana é um termo utilizado para se referir as religiões que se desenvolveram a partir do processo vinda dos povos escravizados do continente africano, embora sejam praticadas por 0,3% da população, de acordo com o Censo do Instituto Brasileiro de Geografia e Estatística (IBGE), as religiões de origem africana são as que mais sofrem discriminação. De acordo com os dados do Disque Direitos Humanos, o Disque 100, da Secretaria de Direitos Humanos da Presidência da República (SDH), de 2011 a 2014, do total de 504 denúncias, 213 informaram a religião atacada. Em 35% desses casos, trata-se de religiões de matriz africana. </h5>
            	...
            	<div class="widget">
                    ...
                    <div id="owl-blog" class="owl-carousel">
                        <div class="blog-carousel">
                            <div class="entry">
                                <img src="https://www.cartacapital.com.br/wp-content/uploads/2015/06/religiao-de-matriz-africana-768x511.jpg" alt="" class="img-responsive">
                        ...
                        <div class="blog-carousel">
                            <div class="entry">
                                <img src="https://s.conjur.com.br/img/b/candomble-umbanda1.png" alt="" class="img-responsive">
        ...
        <div class="container">
        <div data-scroll-reveal="enter from the bottom after 0.3s" class="title text-center" data-scroll-reveal-id="2" data-scroll-reveal-initialized="true" data-scroll-reveal-complete="true">
                        <p style='text-align:left'> Já em dados compilados pela Comissão de Combate à Intolerância Religiosa do Rio de Janeiro (CCIR) mostram que mais de 70% de 1.014 casos de ofensas, abusos e atos violentos registrados no Estado entre 2012 e 2015 são contra praticantes de religiões de matrizes africanas. </p>
        </div>
